...
(function (factory) {
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgInvalidFileType: 'Tipo de archivo inválido "{name}". Sólo "{types}" archivos son soportados.',
        msgInvalidFileExtension: 'Invalid extension for file "{name}". Only "{extensions}" files are supported.',
        msgUploadAborted: 'El archivo subido fue abortado',
        ...
        msgFoldersNotAllowed: 'Sólo arrastre y suelte archivos! {n} folder(s) dropped were skipped.',
        msgImageWidthSmall: 'Ancho de imagen "{name}" debe ser al menos {size} px.',
        msgImageHeightSmall: 'Alto de imagen "{name}" debe ser al menos {size} px.',
        msgImageWidthLarge: 'Ancho de imagen "{name}" no puede exceder {size} px.',
        msgImageHeightLarge: 'Height of image file "{name}" no puede exceder {size} px.',
        msgImageResizeError: 'No se pudo obtener la dimensión de la imagen para redimensionar.',
        msgImageResizeException: 'Error al redimensionar la imagen.<pre>{errors}</pre>',
        dropZoneTitle: 'Arrastre y suelte el archivo aquí &hellip;',
        dropZoneClickTitle: '<br>(or click para seleccionar {files})',
        previewZoomButtonTitles: {
            prev: 'Ver previo archivo',
            next: 'Ver siguiente archivo',
            toggleheader: 'Cambiar cabecera',
            fullscreen: 'Cambiar a full pantalla',
            borderless: 'Cambiar a modo border',
